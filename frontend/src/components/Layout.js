...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Nouvel acte', href: '/procedure/new', icon: Plus },
    { name: 'Historique', href: '/procedure/history', icon: History },
    { name: 'FHIR Viewer', href: '/fhir', icon: FileText },
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-semibold">Radiology DApp</span>
            </div>
            <button
      ...
      <div className="lg:pl-64">
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm lg:hidden">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex items-center">
              <span className="text-lg font-semibold">Radiology DApp</span>
            </div>
          </div>
